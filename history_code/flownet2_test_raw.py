...
def main():
    ...
    flow_controller = FlowController("./flownet2_pre_train/FlowNet2_checkpoint.pth.tar")

    # Prediction given 2 images
    im1 = cv2.imread("./datasets/frame_0001.png")
    im2 = cv2.imread("./datasets/frame_0002.png")

    flow = flow_controller.predict(im1, im2)
    print(im1.shape,flow.shape) # shape = (436,1024)
    ...
    cv2.imwrite("./datas/flow.jpg",flow_image)
